...
const HistoryHeader = () => {
	...
	const downloadFile = () => {
		window.location.href = `https://bazar-api.aralhub.uz/export-data/report/?date=${selectedDate}`
	}

	return (
		<FlexBox
			cls={"flex flex md:flex-row justify-between items-center mb-8 gap-4"}
		>
			<h1
				className={
					"text-xl sm:text-3xl font-medium text-center md:text-left hidden md:block"
				}
			>
				История за месяц
			</h1>
