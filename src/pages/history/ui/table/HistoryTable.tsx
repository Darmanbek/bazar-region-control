...
import type { HistoryDataResponse } from "@/entities/history/model/types/historyType"
...
const HistoryTable = () => {
	...
	const columns: TableProps<HistoryDataResponse>["columns"] = [
		...
		},
		{
			...
			key: "general_count",
			render: (general_count) => general_count.toFixed()
		},
		{
			title: "Всего машин",
			dataIndex: "overall_count",
			key: "overall_count",
			render: (overall_count) => overall_count.toFixed()
		},
		{
			title: "Поток машин",
			dataIndex: "general_attendances_count",
			key: "general_attendances_count",
			render: (general_attendances_count) => general_attendances_count.toFixed()
		},
		{
			title: "Топ 10 машин",
			dataIndex: "top",
	...
	return (
		<Card
			...
			className={
				"shadow-lg rounded-lg overflow-hidden mx-auto my-4 w-full mt-8"
			}
		>
			<Table
				dataSource={data}
